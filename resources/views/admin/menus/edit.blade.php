                    ...
                    <form method="POST" action="{{ route('admin.menus.update', $menu->id) }}"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div id="placeholder_image">
                                <img class="object-cover mb-3 w-32 h-32 rounded" src={{ Storage::url($menu->image) }}>
                            </div>
                            <div class="mb-5">
                                <input
                                    ...
                                    <li
                                        ...
                                        <div class="flex items-center ps-3">
                                            <input id="{{ $category->name }}-checkbox" type="checkbox"
                                                name="categories[]" value="{{ $category->id }}" {{($menu->categories->contains($category->id) ? 'checked' : '')}}
